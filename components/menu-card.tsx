...
import { FavoriteType, UserType } from "@/lib/schemas";
export default function MenuCard({item, isFavorited,user}: {item: MenuItemType, isFavorited?: FavoriteType | undefined, user: UserType | null}) {
    return (
