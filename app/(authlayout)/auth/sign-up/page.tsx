        ...
        <section className="flex-1 w-screen flex flex-col justify-center items-center gap-10">
            <div className="lg:w-96 w-full lg:h-fit h-[calc(100vh-3.5rem)] flex flex-col gap-5 p-3 lg:text-center lg:shadow">
                ...
                <form className="flex flex-col gap-2">
                    <input className="border border-neutral/50 p-2" type="text" placeholder="Username" />
                    <input className="border border-neutral/50 p-2" type="email" placeholder="Email" />
                    <input className="border border-neutral/50 p-2" type="password" placeholder="Password" />
                    <input className="border border-neutral/50 p-2" type="password" placeholder="Confirm Password" />
                    <button className="bg-primary lg:px-5 px-3 lg:py-2 py-1 text-tertiary lg:text-base text-xs" type="submit">Sign up</button>
                </form>
