...
export default function Home() {
  return (
    <main>
      <section className="h-[calc(100dvh-3.5rem)] bg-center bg-cover max-lg:flex  max-lg:flex-col max-lg:justify-end" style={{backgroundImage:"url('/landing-page-bg.jpg')"}}>
